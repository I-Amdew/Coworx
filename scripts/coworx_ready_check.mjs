...
const requiredConcepts = [
  ...
  ["COWORX.md", "Coworx has a shipped local credential memory helper"],
  ["README.md", "Model execution routing"],
  ["README.md", "Task orchestration"],
  ["README.md", "Coworx includes a local credential memory helper"],
  ...
  [".codex/config.toml", "credential_memory_available = true"],
  [".codex/config.toml", "coworx_local_secret_store_enabled = true"],
  [".codex/config.toml", "chrome_password_manager_is_not_coworx_memory = true"],
  ...
  ["docs/standby_mode.md", "Out-Of-Box GUI Dispatch"],
  ["docs/standby_mode.md", "A Messages/iMessage check is not complete"],
  ["docs/standby_mode.md", "Temporary Waits"],
  ["config/TEMPLATE_STANDBY_MODE.json", "dispatch_setup"],
  ["config/TEMPLATE_STANDBY_MODE.json", "computer_use_dispatch"],
  ...
  ["docs/local_credential_persistence.md", "Coworx ships with local credential memory"],
  ["docs/local_credential_persistence.md", "node scripts/coworx_local_secret_store.mjs status"],
  ["docs/local_credential_persistence.md", "If the user asks to use Coworx memory, do not save to Chrome instead"],
  ...
  ["docs/credential_handoff_protocol.md", "Coworx has a shipped local credential memory path"],
  ...
  ["scripts/coworx_local_secret_store.mjs", "credential_memory_available"],
  ["scripts/coworx_local_secret_store.mjs", "chrome_password_manager_is_not_coworx_memory"],
  ...
  ["docs/computer_use_policy.md", "When the user asks to use Coworx credential memory"],
  ...
  ["config/TEMPLATE_CREDENTIAL_HANDOFF.json", "coworx_credential_memory"],
  ["config/TEMPLATE_CREDENTIAL_HANDOFF.json", "chrome_password_manager_is_not_coworx_memory"],
  ...
  ["docs/account_login_handoff.md", "Coworx's shipped credential memory"],
  ...
  ["docs/model_execution_routing.md", "No model may claim Coworx lacks credential memory"],
  ...
  ["scripts/coworx_account_free_regression_tests.mjs", "validateStandbyComputerUseDispatch"],
  ...
  ["evals/regression_tests/account_free_real_work_regressions.json", "coworx_credential_memory_used_when_user_says_remember_it"],
  ["evals/regression_tests/account_free_real_work_regressions.json", "denying_coworx_memory_and_saving_to_chrome_is_rejected"],
  ...
  ["config/TEMPLATE_STANDBY_MODE.json", "one_agent_per_app_at_a_time"],
  ...
  ["scripts/coworx_standby.mjs", "computer_use_dispatch"],
  ["scripts/coworx_computer_use_queue.mjs", "usage_claim_requires_lease_evidence"],
