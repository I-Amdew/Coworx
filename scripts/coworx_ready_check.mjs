...
const requiredConcepts = [
  ...
  ["docs/credential_handoff_protocol.md", "Chat is not a credential source"],
  ["docs/local_credential_persistence.md", "fails or stalls once"],
  ["docs/local_credential_persistence.md", "must not use that chat-memory value directly"],
  ["docs/computer_use_policy.md", "must not type credentials that came from chat memory"],
  ["docs/account_login_handoff.md", "Password-manager autofill"],
  ["docs/account_login_handoff.md", "Chat is not a credential source"],
  ["docs/model_execution_routing.md", "No model may treat chat as a credential source"],
