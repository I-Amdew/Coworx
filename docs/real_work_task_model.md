...
- spreadsheet;
- slide deck;
- message draft or send;
- calendar draft or event;
- organized files;
- report;
...
- Meeting to slides: transcribe or read notes, summarize, create outline, build deck, review, save locally.
- Dashboard summary: map approved dashboard, read metrics, produce report, update workflow memory.
- Message workflow: read approved context, draft message, send when delegated or stage if authority/recipient/content is unclear.
- Meeting scheduling: draft event details, create/invite when delegated or stage uncertain attendees/timing.
- File organization: propose or perform local moves according to authority and log changes.
