...
- the credential source is a local source reference, existing session, password manager/keychain/vault label, connector, environment variable, local skill reference, or ignored private file, not chat text;
